# Importar la libreria beautiful soup, requests y os
...
resultado=requests.get(sitio_web) # Realizar una solicitud HTTP a la pagina
...
# Buscar la etiqueta div en 'main-article' e ignorar el salto de linea
transc=caja.find("div", class_="full-script").get_text(strip=True, separator="") 
print(transc, "\n<Marcelo Pinzon>") #I mprimir de forma entendible la informacion
